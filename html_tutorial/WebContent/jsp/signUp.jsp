	...
	<fieldset id="loginInfo">
		...
		<table class="login">
			<tr><!-- 아이디  -->
				...
				<td class="td2">
					<input type="text" placeholder="영문이름만사용" name="identity" id="identity" class="important" autofocus required>
				</td>
				<td>
	...
	<fieldset id="persnolInfo" class="box drop-shadow lifted">
		...
		<table class="login">
			...
			<tr><!-- 전화번호 -->
				...
				<td>
					<input type="radio" name="telplace" id="telplace" value="office" required>직장
					<input type="radio" name="telplace" id="telplace" value="home" required>자택
				</td>
			</tr>
			<tr><!-- 폰번호 -->
				<td>
			...
			<tr><!-- 주소1 -->
				...
				<td>
					<input type="radio" name="addrplace" id="addrplace" value="office" required>직장
					<input type="radio" name="addrplace" id="addrlace" value="home" required>자택
				</td>
			</tr>
			<tr><!-- 주소2 -->
				<td>
